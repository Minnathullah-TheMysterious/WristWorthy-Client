...
const AdminProductDetails = () => {
  ...
  const [updatedProductImageData, setUpdatedProductImageData] = useState(null);
  ...
  const handleOk = async () => {
    ...
    formData.append("image", updatedProductImageData);
    dispatch(updateProductImageAsync({ productId, formData, imageIndex })).then(
      () => {
        setUpdatedProductImageData(null);
        dispatch(fetchSelectedProductAsync(params.productId));
      }
    );
  };
                ...
                <form className="space-y-5" onSubmit={handleOk}>
                  ...
                  <div className="space-y-2">
                    ...
                    {updatedProductImageData && (
                      <div className="flex justify-center">
                        <img
                          src={URL.createObjectURL(updatedProductImageData)}
                          alt={updatedProductImageData?.name}
                          className="h-52 w-52 "
                        />
                      </div>
                    )}
                    ...
                    >
                      {!updatedProductImageData
                        ? selectedProduct.images[0].originalname
                        : updatedProductImageData?.name}
                      <input
                        type="file"
                        id="product_image1"
                        name="product_image1"
                        ...
                        hidden
                        onChange={(e) => {
                          setUpdatedProductImageData(e.target.files[0]);
                        }}
                      />
                    </label>
                  </div>
                  ...
                  >
                    <form className="space-y-5" onSubmit={handleOk}>
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          {!updatedProductImageData
                            ? selectedProduct.images[1].originalname
                            : updatedProductImageData?.name}
                          <input
                            type="file"
                            id="product_image1"
                  ...
                  >
                    <form className="space-y-5" onSubmit={handleOk}>
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          {!updatedProductImageData
                            ? selectedProduct.images[2].originalname
                            : updatedProductImageData?.name}
                          <input
                            type="file"
                            id="product_image1"
                ...
                >
                  <form className="space-y-5" onSubmit={handleOk}>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        {!updatedProductImageData
                          ? selectedProduct.images[3].originalname
                          : updatedProductImageData?.name}
                        <input
                          type="file"
                          id="product_image1"
