...
// const sortedUniquePrices = uniquePrices.sort((a, b) => a - b);

// const sortedPriceObjects = sortedUniquePrices.map((p) => ({
//   value: p,
//   label: `$${p}`.toString(), // Convert the number to a string for labeling
//   checked: false,
// }));

// console.log(sortedPriceObjects);
